...
Future<void> main() async {
  ...
  final TripsDeparturesDisplayCubit tripsDeparturesDisplayCubit = TripsDeparturesDisplayCubit();

  runApp(BStopApp(stopDisplayCubit: stopDisplayCubit, tripsDeparturesDisplayCubit: tripsDeparturesDisplayCubit));
}
